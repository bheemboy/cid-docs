...
:::info Important
Pay attention to the values for [**Status**](/howto/view-cids#status) and [**Updates**](/howto/view-cids#status) columns. It is recommended to apply updates for CIDs for which both columns show `Ready`.
:::
