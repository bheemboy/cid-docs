...
To keep your OpenLab system secure and stable, it is **essential** to apply operating system (OS) security updates promptly.
:::
...
After this selection, each CID automatically begins **downloading** the updates.

:::info[Important]
Once the download is complete, you must [**initiate the installation**](apply-updates) from the CID Hub.
:::
