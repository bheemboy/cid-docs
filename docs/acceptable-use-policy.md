...
Our Service may have functionality that permits You to share Your Content with others, so please think carefully about what you share. By using the Service, you agree to do so responsibly and to not misuse the Service or help anyone else do so. This includes, but is not limited to, not doing or trying to do any of the following in connection with the Service:

(A) store, transmit or create libelous, obscene, deceptive, defamatory, explicit, unlawful, tortious or otherwise objectionable content (except as necessary for legitimate instructional purposes, but in all cases in compliance with applicable laws and regulations);

(B) modify, translate, adapt, merge, make derivative works of, disassemble, decompile, reverse compile or reverse engineer, attempt to derive the source code of, decrypt, or disable features of any part of the Service except to the extent the foregoing restrictions are expressly prohibited by applicable law or by licensing terms governing the use of third party or open-source components that may be included in the Service;

(C) harm, harass, threaten, or impersonate any person or violate the rights of any third party;
...
(G) introduce viruses, Trojan horses, worms, spyware, or other such malicious code into the Service;
...
(K) send unsolicited communications, promotions or advertisements, or spam;

(L) send altered, deceptive or false source-identifying information, including "spoofing" or "phishing";

(M) promote or advertise products or services other than your own without appropriate authorization;

(N) sublicense, sell or re-sell the Service unless specifically authorized to do so;

(O) copy, reproduce, create derivative works, distribute, republish, download, display, post or transmit in any form or by any means any part of the Service unless specifically authorized to do so;

(P) use the Service to make or distribute an application, a principal purpose of which, as reasonably determined by Agilent, is to perform the same or similar functions as the Service, or which replaces any component of the Service, or otherwise use the Service to compete with Agilent;

(Q) remove, deface, cover, alter, obscure or destroy any copyright or trademark notices or other proprietary markings contained on or in the Service; or

(R) violate the law in any way, including by storing, publishing or sharing material that is infringing, fraudulent, defamatory, misleading, or damaging to Agilent in any way.
